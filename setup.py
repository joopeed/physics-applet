...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "jogin.py"
 
        #Name of program
        self.project_name = "Applet de Contracao de Comprimento"
 
        #Project url
        self.project_url = "http://splab.ufcg.edu.br/~joaopedro/physics"
        ...
        #Auhor of program
        self.author_name = "Joao Pedro Leoncio"
        self.author_email = "joopeeds@gmail.com"
        self.copyright = "Copyright (c) 2014 Joao Pedro."
 
        #Description
        self.project_description = "Applet de experimento de relatividade"
